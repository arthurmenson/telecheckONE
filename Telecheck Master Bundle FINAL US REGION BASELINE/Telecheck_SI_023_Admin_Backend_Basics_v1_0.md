...
--   WHERE ... FOR UPDATE` lock at start; serializes concurrent submits keyed by
--   (tenant_id, forms_template_id). This is the SOLE enforceable serialization point

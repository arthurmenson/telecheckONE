...
-- Subsequent sweep transactions STEP A atomically increment + RETURNING (R62 HIGH-1 renamed from STEP 2):
...
-- STEP C fan-out INSERT (R62 HIGH-1 renamed from STEP 3) uses v_sweep_cycle_id directly as attempt_sequence (NOT MAX+1):
INSERT INTO notification_crisis_provider_attempt

...
**Decision:** **17 merge-blocking integration tests** (R18+R21+R22 MED closures 2026-05-21: "17" counts numbered tests 1-15 + #17 contention benchmark; test 16 expanded into 10 sub-tests 16a-16j ALL merge-blocking; R10 added 16a-d; R11 added 16e-f; R13 added 16g; R16 added 16h; R20 added 16i; R22 added 16j negative-config) + 3 static-analyzer rules (mirrors P-035 Mode 1 + P-037 SI-020 pattern):

**CI gate language (R18+R21+R22 MED):** merge gate requires ALL of tests 1-15 + 16a + 16b + 16c + 16d + 16e + 16f + 16g + 16h + 16i + 16j + 17 to PASS. Total **26 individual assertions** (15 base + 10 sub-tests + 1 benchmark).

**Integration tests (17 base entries, 16 expanded into 16a-16j sub-cluster):**

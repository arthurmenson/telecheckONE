...
**Total: 10 new action IDs (8 Cat A + 0 Cat B + 2 Cat C; was 8 Cat A + 0 Cat B + 1 Cat C pre-R45 MED-1 closure 2026-05-21).** §1 in-scope tally + §3 header line + all per-action-class counters updated.

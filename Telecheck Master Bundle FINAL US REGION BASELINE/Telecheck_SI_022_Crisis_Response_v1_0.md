...
**11 new action IDs** under `crisis.*` namespace EXTENDING P-025 (which contributed `crisis.escalation_destination_resolved` Cat B): **8 Cat A + 0 Cat B + 3 Cat C** (R13 added crisis.final_tier_reached Cat A; R1 moved no_acknowledgement_escalation Cat B → Cat A; R43+R45 added 2 sweep recovery Cat C events; R49 added crisis.delivery_fence_mismatch_dropped Cat C):
...
**Total: 11 new action IDs (8 Cat A + 0 Cat B + 3 Cat C; was 8 Cat A + 0 Cat B + 2 Cat C pre-R49 HIGH-1 closure 2026-05-21; was 8 Cat A + 0 Cat B + 1 Cat C pre-R45 MED-1 closure 2026-05-21).** §1 in-scope tally + §3 header line + all per-action-class counters updated.

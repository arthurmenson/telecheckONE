...
3. STEP 5 (final; R46 HIGH-1 + R47 HIGH-1 closure 2026-05-21: **final guarded compare-and-set sets BOTH completed_at AND sweep_cycle_id_committed atomically** so the durable replay marker is unambiguously post-ownership-revalidation):
```sql
UPDATE crisis_sweep_execution

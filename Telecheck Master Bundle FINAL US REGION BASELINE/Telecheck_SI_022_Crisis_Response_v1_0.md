...
**Decision:** **17 merge-blocking integration tests** (R18 MED-1 + R21 MED-1 closure 2026-05-21: "17" counts numbered tests 1-15 + #17 contention benchmark; test 16 is expanded into 9 sub-tests 16a-16i ALL of which are merge-blocking — sub-tests do NOT count toward the 17 total but ALL must pass for merge gate per CI gate language below; R10 added 16a-d; R11 added 16e-f; R13 added 16g; R16 added 16h; R20 added 16i) + 3 static-analyzer rules (mirrors P-035 Mode 1 + P-037 SI-020 pattern):

**CI gate language (R18 MED-1 + R21 MED-1 closure):** the merge gate requires ALL of tests 1-15 + 16a + 16b + 16c + 16d + 16e + 16f + 16g + 16h + 16i + 17 to PASS. Total **25 individual assertions** (15 base + 9 sub-tests + 1 benchmark). An implementation claiming compliance MUST execute and pass every individually-listed sub-test; CI script enumerates them all explicitly.

**Integration tests (17 base entries, with 16 expanded into 16a-16i sub-cluster covering R10+R11+R13+R16+R20 closures):**

...
**Status:** Accepted (v1.0 — Phase 6 promoted 2026-05-01 per Evans's "authorized" instruction; promoted from v0.4 DRAFT after Codex Phase 4 EXIT v0.2 verification CLOSED. Quad sign-off: Product Lead + Engineering Lead + Clinical Safety Officer + Privacy Officer.)

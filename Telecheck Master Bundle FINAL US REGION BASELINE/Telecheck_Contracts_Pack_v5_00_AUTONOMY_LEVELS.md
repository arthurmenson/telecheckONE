...
**Version:** 5.4 (Phase 6 promoted 2026-05-01 per Evans's "authorized" instruction; promoted from v0.4.1 DRAFT after Codex Phase 3 group-1 EXIT + Phase 6 plan EXIT v0.4 CLOSED)

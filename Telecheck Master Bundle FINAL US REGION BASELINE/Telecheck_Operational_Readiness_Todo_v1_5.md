...
| OR-109 | Pricing document + unit economics model — **scope expanded 2026-04-25 to include per-tenant unit economics (Heros + Telecheck-Ghana) and platform-fee model per Master PRD v1.9 §18** | Counsel Product, Registry §6, Master PRD v1.9 §18 |

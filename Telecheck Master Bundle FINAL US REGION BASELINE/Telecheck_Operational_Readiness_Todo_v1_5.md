...
| OR-234 | US legal entity stack for Heros tenant — state telehealth registrations, LegitScript certification, BAA with AWS | Master PRD v1.9 §4.1, ADR-024 |
...
| OR-116 | **Research Ethics Committee (REC) partnership designation — Ghana** — designate REC/IRB partner for Telecheck-Ghana 5th-tier research data-use consent oversight (per Master PRD v1.10 §24 row 11; ADR-028 v0.5 Activation requirements §2). Owner: Privacy Officer + Telecheck-Ghana team. Candidates: Ghana Health Service REC, Noguchi Memorial Institute IRB. Required pre-launch (5th consent tier active at launch per Master PRD §15.2). _(Added 2026-05-02 per v1.10.1 hygiene cycle Phase5 delta Row 75 — C5 research data partnership.)_ | Master PRD v1.10 §24 row 11, ADR-028 v0.5 |
| OR-117 | **Research data-use consent text — drafted + ethics-reviewed** — draft 5th-tier consent text and run through REC/IRB ethics review (per Master PRD v1.10 §24 row 12; ADR-028 v0.5). Owner: Privacy Officer + Legal + REC partner. Required pre-launch. Asymmetric retraction language explicit; optional, separately revocable, no care impact (per I-030). _(Added 2026-05-02 per v1.10.1 hygiene cycle Phase5 delta Row 75 — C5 research data partnership.)_ | Master PRD v1.10 §24 row 12, ADR-028 v0.5, INVARIANTS v5.2 I-030 |
...
| OR-303 | US BAA structure for us-east-1 processing — standard HIPAA-region BAA chain documentation for US tenant (Heros) patient data processed in us-east-1. Per ADR-026 this is the standard HIPAA-region chain (Heros → Telecheck → AWS US, all US-jurisdiction) — simpler than the prior cross-border framing under ADR-025. | ADR-024 implementation, ADR-026 region |
...
| 2026-04-26 | OR-303 | Open (simplified) | US BAA structure under ADR-026 is a standard HIPAA-region chain (Heros → Telecheck → AWS US, all US-jurisdiction). Was non-standard cross-border BAA framing under ADR-025; the cross-border concern is removed for the US tenant under ADR-026. |

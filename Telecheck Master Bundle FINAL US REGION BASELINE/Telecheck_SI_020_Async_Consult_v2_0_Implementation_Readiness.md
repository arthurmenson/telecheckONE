...
BEGIN
    ...
    -- (Optional: emit Cat B audit event ai.async_consult.claim_expired_auto_released if expired
    --  claim found; documented in §3 sub-decision 2)
...
Authored on `spec/si-020-async-consult-v2-0-implementation-readiness-2026-05-21` branch off main at `3b10b4c` (post-P-036 + Addendum 64). v0.2 commit `b34e7b0`. v0.3 commit `fca9e35`. v0.4 commit `79a4e24`. v0.5 commit `5cc2f1f`. v0.6 commit pending push for R6 verification.

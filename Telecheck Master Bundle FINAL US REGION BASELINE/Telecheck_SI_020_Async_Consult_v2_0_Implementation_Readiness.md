...
Authored on `spec/si-020-async-consult-v2-0-implementation-readiness-2026-05-21` branch off main at `3b10b4c` (post-P-036 + Addendum 64). v0.2 commit `b34e7b0`. v0.3 commit `fca9e35`. v0.4 commit `79a4e24`. v0.5 commit `5cc2f1f`. v0.6 commit `3fca49c`. v0.7 commit `feb7cf0`. v0.8 commit `14a39e8`. v0.9 commit pending push for R9 ship-it verification.

...
**Naming reconciliation:** the amendment artifact filename labels "v5.5 → v5.6" reflecting Sprint 20 baseline miscount; actual canonical transition is **v5.3 → v5.4** (amendment CONTENT correct; version label off-by-one). v1.10.1 hygiene-cycle "headers-govern + filenames-stable" pattern preserved.

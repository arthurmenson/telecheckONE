...
- **The four downstream SECURITY DEFINER procedures** (SI-005's two at P-021; SI-008's at P-018; SI-009's at P-019) remain at spec-ratified-but-IMPL-blocked status. Their **own ratifications did NOT depend on SI-010** — only the SI-010 source's claim of "unblocks four procedures" implied dependency. Rejection of SI-010 does not invalidate the four procedures' ratifications; they re-target the canonical middleware-GUC model.

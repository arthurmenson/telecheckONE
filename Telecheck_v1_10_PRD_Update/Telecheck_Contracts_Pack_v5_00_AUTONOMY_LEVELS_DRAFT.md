# Telecheck — Contracts Pack v5.1 · AUTONOMY_LEVELS (DRAFT)

**Version:** 0.4 DRAFT (v0.4 — Phase 3 reconciliation against canonical Master PRD v1.10 §13.7 v0.3; I-012 reject-unless three-clause rule + `fully_autonomous` strict-superset 5-item activation prerequisites + ADR-and-activation-audit two-condition AND mirror §13.7 normative wording exactly)

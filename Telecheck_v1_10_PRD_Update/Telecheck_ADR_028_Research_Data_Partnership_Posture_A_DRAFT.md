# ADR-028 — Research data partnership (Posture A) as Release 2 goal (DRAFT)

**Status:** v0.5 DRAFT — Proposed for Acceptance on v1.10 promotion. Phase 4 propagation pass applied 2026-05-01: §X NEW references resolved to canonical §15.3 (Phase 2 cleanup); contract version references bumped v5.1 → v5.2 (Phase 3 cleanup); brand framing aligned with C3 cleanup (Heros surfaces → Heros Health DBA surfaces).

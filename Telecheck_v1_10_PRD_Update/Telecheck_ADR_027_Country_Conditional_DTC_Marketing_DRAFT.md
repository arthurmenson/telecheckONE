# ADR-027 — Country-conditional DTC marketing posture (DRAFT)

**Status:** v0.6 DRAFT — Proposed for Acceptance on v1.10 promotion. Phase 4 propagation pass applied 2026-05-01: §13.2 Governance review process references normalized to canonical §13.2 (Phase 2 cleanup); contract version references bumped v5.1 → v5.2 (Phase 3 cleanup); activation mechanism completeness updates per CCR_RUNTIME v5.2 4-key marketing block.

    ...
    <div className="scr">
      ...
      <div className="scroll">
        ...
        <div className="hero">
          ...
          <h1>Your <em>team</em> and visits.</h1>
          <div className="sub">Dr. Mensah replies within the hour. Nurse Adjoa on async.</div>
        </div>
        <SubTabs items={["Visits","Team","Messages","Program"]} active={sub} onPick={setSub}/>

        {sub === "Visits" && <>
          <div className="sect"><div className="t">Upcoming</div><span className="link" onClick={() => toast("Book a visit")}>+ Book</span></div>
          <div className="tl">
            <div className="tl-r" onClick={() => nav("visit")}>
              <div className="tl-tm">10:30</div>
              <div className="tl-body">
                <div className="tl-t">Dr. Mensah · video</div>
                <div className="tl-s">15-min follow-up · today</div>
                <span className="tl-tag ok">Ready</span>
              </div>
              <div className="chev"><I n="chev" s={16} sw={1.8}/></div>
            </div>
            <div className="tl-r" onClick={() => toast("Home draw details")}>
              <div className="tl-tm">Thu</div>
              <div className="tl-body">
                <div className="tl-t">Home lab draw</div>
                <div className="tl-s">HbA1c + kidney panel · 08:00</div>
                <span className="tl-tag neutral">Booked</span>
              </div>
              <div className="chev"><I n="chev" s={16} sw={1.8}/></div>
            </div>
            <div className="tl-r" onClick={() => toast("Visit details")}>
              <div className="tl-tm">2 May</div>
              <div className="tl-body">
                <div className="tl-t">Ophthalmology screen</div>
                <div className="tl-s">Annual retinal · Korle-Bu</div>
                <span className="tl-tag neutral">In-person</span>
              </div>
              <div className="chev"><I n="chev" s={16} sw={1.8}/></div>
            </div>
          </div>
          <div className="sect"><div className="t">Past · last 3 months</div></div>
          <div className="tl">
            <div className="tl-r" onClick={() => toast("Visit notes")}>
              <div className="tl-tm">14 Apr</div>
              <div className="tl-body">
                <div className="tl-t">Dr. Mensah · video</div>
                <div className="tl-s">Quarterly · HbA1c discussion</div>
              </div>
              <div className="chev"><I n="chev" s={16}/></div>
            </div>
            <div className="tl-r" onClick={() => toast("Visit notes")}>
              <div className="tl-tm">02 Mar</div>
              <div className="tl-body">
                <div className="tl-t">Nurse Adjoa · async</div>
                <div className="tl-s">Diet check-in</div>
              </div>
              <div className="chev"><I n="chev" s={16}/></div>
            </div>
          </div>
        ...
        {sub === "Team" && <>
          <div className="sect"><div className="t">Your team</div><span className="link" onClick={() => toast("Invite provider")}>+ Invite</span></div>
          <div>
            <div className="row" onClick={() => nav("care-team")}><div className="row-ic"><I n="user" s={18}/></div><div className="row-body"><div className="row-t">Dr. Akosua Mensah</div><div className="row-s">Endocrinology · primary · replies &lt;1h</div></div><div className="chev"><I n="chev" s={16}/></div></div>
            <div className="row" onClick={() => nav("care-team")}><div className="row-ic"><I n="user" s={18}/></div><div className="row-body"><div className="row-t">Nurse Adjoa Boateng</div><div className="row-s">Diabetes coach · async</div></div><div className="chev"><I n="chev" s={16}/></div></div>
            <div className="row" onClick={() => nav("care-team")}><div className="row-ic"><I n="user" s={18}/></div><div className="row-body"><div className="row-t">Dr. Kwame Owusu</div><div className="row-s">GP · referrals · ad-hoc</div></div><div className="chev"><I n="chev" s={16}/></div></div>
            <div className="row" onClick={() => nav("care-team")}><div className="row-ic"><I n="user" s={18}/></div><div className="row-body"><div className="row-t">Kojo Mensah · brother</div><div className="row-s">Family delegate · 3 scopes</div></div><div className="chev"><I n="chev" s={16}/></div></div>
          </div>
        </>}

        {sub === "Messages" && <>
          <div className="sect"><div className="t">Threads</div><span className="link" onClick={() => toast("New message")}>+ New</span></div>
          <div>
            <div className="row" onClick={() => nav("care-thread")}>
              <div className="row-ic" style={{ background: "var(--teal-50)", color: "var(--teal-600)" }}><I n="user" s={18}/></div>
              <div className="row-body">
                <div className="row-t">Dr. Mensah <span style={{ color: "var(--ink-4)", fontSize: 10.5, marginLeft: 6, fontWeight: 400 }}>· 09:08</span></div>
                <div className="row-s">Saw your evening log — let's talk about timing at 10:30.</div>
              </div>
              <span className="tl-tag ok" style={{ margin: 0 }}>New</span>
            </div>
            <div className="row" onClick={() => nav("care-thread")}>
              <div className="row-ic"><I n="user" s={18}/></div>
              <div className="row-body">
                <div className="row-t">Nurse Adjoa <span style={{ color: "var(--ink-4)", fontSize: 10.5, marginLeft: 6, fontWeight: 400 }}>· Sun</span></div>
                <div className="row-s">Nice walk streak. Try cutting rice portion by a third on Fri.</div>
              </div>
            </div>
            <div className="row" onClick={() => nav("care-thread")}>
              <div className="row-ic"><I n="user" s={18}/></div>
              <div className="row-body">
                <div className="row-t">Pharmacy · Mobipharm <span style={{ color: "var(--ink-4)", fontSize: 10.5, marginLeft: 6, fontWeight: 400 }}>· 14 Apr</span></div>
                <div className="row-s">Your order is ready for dispatch on 22 Apr.</div>
              </div>
            </div>
          </div>
        </>}
        ...
        {sub === "Program" && <>
          <div style={{ height: 14 }}/>
          <div className="prog" onClick={() => toast("Program details")}>
            <div className="prog-h">
              <div className="prog-t">Diabetes RPM · Dr. Mensah</div>
              <div className="prog-w">WEEK 12 / 26</div>
            </div>
          ...
          <div className="sect"><div className="t">Weekly tasks</div></div>
          <div className="tl">
            <div className="tl-r"><div className="tl-tm">Mon</div><div className="tl-body"><div className="tl-t">Glucose logs · 3/day</div><div className="tl-s">5 of 7 days complete</div><span className="tl-tag ok">On track</span></div></div>
            <div className="tl-r"><div className="tl-tm">Wed</div><div className="tl-body"><div className="tl-t">30-min walk</div><div className="tl-s">Streak 4 weeks</div><span className="tl-tag ok">On track</span></div></div>
            <div className="tl-r"><div className="tl-tm">Fri</div><div className="tl-body"><div className="tl-t">Weekly check-in</div><div className="tl-s">3 questions · due today</div><span className="tl-tag warn">Due</span></div></div>
          </div>
          <div className="sect"><div className="t">Milestones</div></div>
          <div>
            <div className="row"><div className="row-ic" style={{ background: "var(--teal-50)", color: "var(--teal-600)" }}><I n="check" s={18}/></div><div className="row-body"><div className="row-t">Baseline labs</div><div className="row-s">Completed · 18 Jan</div></div></div>
            <div className="row"><div className="row-ic" style={{ background: "var(--teal-50)", color: "var(--teal-600)" }}><I n="check" s={18}/></div><div className="row-body"><div className="row-t">Month-3 review</div><div className="row-s">Completed · 14 Apr</div></div></div>
            <div className="row"><div className="row-ic"><I n="clock" s={18}/></div><div className="row-body"><div className="row-t">Month-6 review</div><div className="row-s">Due 12 Jul</div></div></div>
          </div>
        </>}
